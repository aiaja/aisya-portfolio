...
const IMGS = [
  "/assets/tentang-1.jpg",
  "/assets/tentang-2.jpg",
  "/assets/tentang-3.jpg",
  "/assets/tentang-4.jpg",
  "/assets/tentang-5.jpg",
  "/assets/tentang-6.jpg",
  "/assets/tentang-7.jpg",
  "/assets/tentang-8.png",
  "/assets/tentang-9.jpg",
];
...
const RollingGallery = ({
  ...
  return (
    <div className="relative h-[500px] w-full overflow-hidden">
      <h2 className="text-3xl font-bold mb-2 text-center">Captured Moment</h2>
